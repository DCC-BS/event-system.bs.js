...
export declare const useCommandBus: () => {
     ...
     */
    registerHandler: <TCommand extends import("../models/commands.js").ICommand>(commandType: import("../models/commands.js").CommandType, handler: import("../services/command-bus.js").CommandHandler<TCommand>) => void;
    /**
     ...
     */
    unregisterHandler: <TCommand extends import("../models/commands.js").ICommand>(commandType: import("../models/commands.js").CommandType, handler: import("../services/command-bus.js").CommandHandler<TCommand>) => void;
    /**
     * Executes all handlers registered for the given command.
     *
     * @param command - The command to execute.
     */
    executeCommand: (command: import("../models/commands.js").ICommand, history?: boolean) => Promise<void>;
    /**
